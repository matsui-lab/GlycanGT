...
OUTPUT_DIR = os.path.join(PROJECT_ROOT, 'outputs', 'mask_15')
...
def run_final_training():
    ...
    best_epochs = {'ss': 158, 'small': 129, 'medium': 365, 'large': 319}
    ...
    for config_name in model_sizes_to_run:
        ...
        print(f"\n===== Final Training {config_name} ({num_epochs} epochs, mask 15%) =====")
        ...
        # --- 6. saving models ---
        save_path = os.path.join(OUTPUT_DIR, f"pretrained_tokengt_{config_name}_multitask_mask_15_final.pt")
        torch.save(model.state_dict(), save_path)
        
        history_filename = os.path.join(OUTPUT_DIR, f"final_pretrain_loss_history_{config_name}_multitask_mask_15.csv")
