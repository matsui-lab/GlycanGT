...
def save_summary_results(results: dict):
    ...
    output_path = os.path.join(OUTPUT_DIR, 'training_summary_mask_45.txt')
...
if __name__ == "__main__":
    # Hyperparameters
    hparams = {'num_epochs': 1000, 'patience': 30, 'learning_rate': 1e-6, 'batch_size': 32, 'masking_ratio': 0.45, 'edge_loss_weight': 0.5}
    ...
    for size in model_sizes_to_run:
        ...
        history_filename = os.path.join(OUTPUT_DIR, f"loss_history_{size}_multitask_mask_45.csv")
