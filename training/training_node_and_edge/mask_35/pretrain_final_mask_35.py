...
OUTPUT_DIR = os.path.join(PROJECT_ROOT, 'outputs', 'mask_35')
...
def run_final_training():
    ...
    best_epochs = {'ss': 158, 'small': 234, 'medium': 506, 'large': 485}
    ...
    for config_name in model_sizes_to_run:
        ...
        print(f"\n===== Final Training {config_name} ({num_epochs} epochs, mask 35%) =====")
        ...
        # --- 6. saving models ---
        save_path = os.path.join(OUTPUT_DIR, f"pretrained_tokengt_{config_name}_multitask_mask_35_final.pt")
        torch.save(model.state_dict(), save_path)
        
        history_filename = os.path.join(OUTPUT_DIR, f"final_pretrain_loss_history_{config_name}_multitask_mask_35.csv")
