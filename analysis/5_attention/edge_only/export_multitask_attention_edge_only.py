...
OUTPUT_DIR = os.path.join(PROJECT_ROOT, 'analysis', '5_attention', 'edge_only', 'attention_visualization')
...
def main(model_size: str, json_path: str, layer: int):
    ...
    try:
        ...
        model_path = os.path.join(PRETRAINED_DIR, f"pretrained_tokengt_{model_size}_multitask_edge70_final.pt")
